    ...
    <div>
      ...
      <section className="container m-5 p-5">
        <div className="row pb-5">
          <div className="col-md-9 slide-top">
            ...
            <h2>Speedy medicine delivery at your fingertips.</h2>
          </div>
              ...
              <div className="bg-light card border-0 shadow ">
                <div className="card-body">
                  ...
                  <p className="card-text">
                    ...
                    commitment to your well-being, our experienced pharmacists
                    and dedicated staff are here to provide personalized care
                    and support. Our mission is to ensure your access to{" "}
                    <strong>
                      essential medications, health information, and a friendly,
              ...
              <div className="card relative-div">
                <div className="card-body">
                  <Image
                    ...
                    height={45}
                    width={45}
                    className="absolute-icon rounded-circle bg-white shadow"
                  />
                  <h5 className="card-title text-primary ms-4 ps-1">
                    Online platform
                  </h5>
                  <h6 className="card-subtitle mb-2 text-muted">
                    Hate the pharmacy commute? We've got you!
                  </h6>
                  <p className="card-text">
                    Say goodbye to unnecessary trips to the pharmacy, with
                    XPharmacies you can now buy all the medicine you want at the
                    touch of a button!
                  </p>
                </div>
              </div>
            ...
            <div className="col-md-6">
              <div className="card relative-div">
                <div className="card-body">
                  ...
                  <h6 className="card-subtitle mb-2 text-muted">
                    Got a time-sensitive medical emergency?
                  </h6>
                  <p className="card-text">
                    Our couriers are available 24/7 to accomodate for yur
                    medical needs and deliver them to your doorstep in no time!
                  </p>
                </div>
              </div>
              <br />
            ...
            <div className="col-md-6">
              <div className="card relative-div">
                <div className="card-body">
                  ...
                  <h6 className="card-subtitle mb-2 text-muted">
                    Need info on a specific product?
                  </h6>
                  <p className="card-text">
                    No more guessing! Get a your medication info from the
                    proffessionals, with the help of our fully-descriptive
                    product platform!
                  </p>
                </div>
              </div>
            ...
            <div className="col-md-6">
              <div className="card relative-div">
                <div className="card-body">
                  ...
                  <h6 className="card-subtitle mb-2 text-muted">
                    Need frequent refills? Your health is our top priority!
                  </h6>
                  <p className="card-text">
                    Chronical illnesses made a easier with our scheduled
                    automatic medicication refill services.
                  </p>
                </div>
              </div>
              <br />
            ...
            <div className="col-md-8 mx-auto ">
              ...
              >
                <ul className="carousel-indicators d-flex flex-row justify-content-center align-items-center text-center me-auto">
                  <li
                    className="active col-md-1 align-self-center"
                    ...
                    <div className="card border-0 shadow p-5 relative-div mt-5">
                      <div className="card-body mx-4 ">
                        <Image
                          ...
                          height={100}
                          width={100}
                          className="absolute-testimonial-image rounded-circle bg-white shadow"
                        />
                        ...
                        <hr className="w-75" />
                        <p className="card-text">
                          "XPharmacies has made healthcare so convenient. I can
                          now buy my medicine from the comfort of my screen, no
                          calls required. It's a game-changer!"{" "}
                        </p>
                      </div>
                    </div>
                  </div>
                  <div className="carousel-item card-height">
                    <div className="card border-0 shadow p-5 relative-div mt-5">
                      <div className="card-body mx-4">
                        ...
                        <hr className="w-75" />
                        <p className="card-text">
                          "As a mother of three, XPharmacies has saved me so
                          much stress!! No more worrying about my kids'
                          symptoms, i can just order the necessary medication in
                          the matter of seconds. Made my life a whole lot
                  ...
                  <div className="carousel-item card-height">
                    <div className="card border-0 shadow p-5 relative-div mt-5">
                      <div className="card-body mx-4">
                        ...
                        <hr className="w-75" />
                        <p className="card-text">
                          "I was skeptical about automatic refills, but the
                          staff at XPharmacies have been incredibly consistent
                          and fast. No more need to manually order refills a
                          week before."{" "}
                        </p>
                      </div>
                    </div>
      ...
      <section className="container p-5 ">
        <h2 className="text-center py-3">
          <strong>Get to know our success, but in numbers..</strong>
        </h2>
      ...
      <section className="bg-light py-5">
        <div className="container text-center">
          <h2 className="py-3">
            <strong>
              Sign up and never worry about your medication again!
            </strong>
          </h2>
          <div className="">
            <a
